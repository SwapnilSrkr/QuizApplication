    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //------------------------------------------------------------------------------------------
                if (question1_choice3.isChecked())
                    final_score++;
                //------------------------------------------------------------------------------------------
                ...
                if (question2_choice2.isChecked())
                    final_score++;
                //------------------------------------------------------------------------------------------
                // Question 3 - Correct Answer is #1, #2, #3 and #4
                //------------------------------------------------------------------------------------------
                if (question3_choice1.isChecked() && question3_choice2.isChecked() && question3_choice3.isChecked() && question3_choice4.isChecked())
                    final_score++;
                //------------------------------------------------------------------------------------------
                // Question 4 - Correct Answer is Dmitri Mendeleev
                //------------------------------------------------------------------------------------------
                if (question4_answer.getText().toString().toLowerCase().equals("dmitri mendeleev"))
                    final_score++;
                //------------------------------------------------------------------------------------------
                // Question 5 - Correct Answer is #1, #2
                //------------------------------------------------------------------------------------------
                if (question5_choice1.isChecked() && question5_choice2.isChecked())
                    final_score++;
                //------------------------------------------------------------------------------------------
                // Question 6 - Correct Answer is Gold
                //------------------------------------------------------------------------------------------
                if (question6_answer.getText().toString().toLowerCase().equals("gold"))
                    final_score++;
                //------------------------------------------------------------------------------------------
                ...
                if (question7_choice1.isChecked())
                    final_score++;
                //------------------------------------------------------------------------------------------
                // Question 8 - Correct Answer is Ethylene
                //------------------------------------------------------------------------------------------
                if (question8_answer.getText().toString().toLowerCase().equals("ethylene"))
                    final_score++;
                //------------------------------------------------------------------------------------------
                // Question 9 - Correct Answer is #4
                //------------------------------------------------------------------------------------------
        ...
        fab3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String shareBody = "Hey! Love Quizzes? My highscore is " + final_score + " on Chemistry\nCan you beat me?\nDownload the app from https://twitter.com/Swapnilsrkr";
