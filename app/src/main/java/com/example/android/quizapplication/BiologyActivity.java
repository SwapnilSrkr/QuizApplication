    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LayoutInflater inflater = (LayoutInflater) BiologyActivity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                ...
                float density = BiologyActivity.this.getResources().getDisplayMetrics().density;
        ...
        fab3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String shareBody = "Hey! Love Quizzes? My highscore is " + final_score + " on Biology\nCan you beat me?\nDownload the app from https://twitter.com/Swapnilsrkr";
